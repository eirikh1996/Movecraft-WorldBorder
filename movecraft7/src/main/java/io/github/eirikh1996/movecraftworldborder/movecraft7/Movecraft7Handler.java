package io.github.eirikh1996.movecraftworldborder.movecraft7;
...
public class Movecraft7Handler implements Listener {
    private final WorldBorder worldBorderPlugin;

    public Movecraft7Handler(WorldBorder worldBorderPlugin) {
